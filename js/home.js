...
function getXsTemplate() {
    ...
    '<!-- our story --><div class="col"><ul><li class="mb-3"><router-link class="xs-home-bottom-list-item" to="/story">Our story</router-link></li><li class="mb-3"><router-link class="xs-home-bottom-list-item" to="/guest">Guest list</router-link></li></ul></div></div>' +
